...
namespace Obligatorio
{
    public static class CargaDeDatosIniciales
    {
        ...
        {
            //          ----- MÉDICOS -----
            Medico medico1 = new Medico("Francisco", "Arenas", "franarenas@clinicaVS.com", "1234", "Médicina General", "M001", new List<string> { "Lunes", "Miércoles" }, new List<TimeSpan> { new TimeSpan(9, 0, 0), new TimeSpan(9, 30, 0) });

            Medico medico2 = new Medico("Megan", "Avila", "megan.avila@clinicaVS.com", "1234", "Neurología", "M002", new List<string> { "Martes", "Jueves" }, new List<TimeSpan> { new TimeSpan(10, 0, 0), new TimeSpan(10, 30, 0) });
            ...
            //          ----- PACIENTES -----
            Paciente paciente1 = new Paciente("María", "Rodríguez", "mariarodriguez@gmail.com", "1234", "5634406-4", "099111111", new DateTime(1990, 5, 12), "mariarodriguez@gmail.com", "ASSE");
            ...
            Paciente paciente3 = new Paciente("Lucas", "García", "lucasgarcia@gmail.com", "1234", "5036406-1", "099333333", new DateTime(2003, 2, 15), "lucasgarcia@gmail.com", "ASSE");
            Paciente paciente4 = new Paciente("Diego", "Díaz", "diediaz@gmail.com", "1234", "5234306-9", "099444444", new DateTime(1992, 11, 5), "diediaz@gmail.com", "CAMEC");
            Paciente paciente5 = new Paciente("Leopoldo", "Torres", "leotorres@gmail.com", "1234", "5133868-1", "099555555", new DateTime(2002, 10, 17), "leotorres@gmail.com", "BPS");
            Paciente paciente6 = new Paciente("Martin", "Bidart", "tinchobidart@gmail.com", "1234", "5333333-9", "099666666", new DateTime(2011, 6, 26), "tinchobidart@gmail.com", "BPS");
            Paciente paciente7 = new Paciente("Leo", "Messi", "goat@gmail.com", "1234", "3434343-4", "099777777", new DateTime(1987, 6, 24), "goat@gmail.com", "BPS");
            Paciente paciente8 = new Paciente("Neymar", "Junior", "elprincipe@gmail.com", "1234", "5130003-0", "099888888", new DateTime(1992, 3, 5), "elprincipe@gmail.com", "");
            Paciente paciente9 = new Paciente("Pancho", "Vega", "vegapancho@gmail.com", "1234", "3256383-9", "099999999", new DateTime(1990, 9, 2), "vegapancho@gmail.com", "CAMEC");
            Paciente paciente10 = new Paciente("Martin", "Damonte", "deimontmartin@gmail.com", "1234", "5391247-7", "099101010", new DateTime(2003, 11, 23), "deimontmartin@gmail.com", "ASSE");
            ...
            //          ----- PAGOS -----
            clinica.RegistrarPago(1, 1500m, MetodoPago.Efectivo, false);
            clinica.RegistrarPago(3, 2000m, MetodoPago.Debito, false);
        }
    }
}
